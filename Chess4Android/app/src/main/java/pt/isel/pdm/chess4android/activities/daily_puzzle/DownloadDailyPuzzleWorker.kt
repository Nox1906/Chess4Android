...
import pt.isel.pdm.chess4android.common.DailyPuzzleChessRepository
...
: ListenableWorker(appContext, workerParams) {
    override fun startWork(): ListenableFuture<Result> {
        ...
        val repo = DailyPuzzleChessRepository(app.dailyPuzzleService, app.dailyPuzzleHistoryDB.getHistoryDataBase())
